 ...
 */
@Data
@TableName("information_technology_course_statistics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="information_technology_course_statistics对象", description="信息教学统计")
public class InformationTechnologyCourseStatistics implements Serializable {
	...
	/**课时数*/
	@Excel(name = "课时数", width = 15)
    @ApiModelProperty(value = "课时数")
    private java.lang.Integer totalNumberOfCourses;
	/**创建人*/
