 ...
 */
@Data
@TableName("fusion_subject_course_statistics")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="fusion_subject_course_statistics对象", description="学科融合统计")
public class FusionSubjectCourseStatistics implements Serializable {
