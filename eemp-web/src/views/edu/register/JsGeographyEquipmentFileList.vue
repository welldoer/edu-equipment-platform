<template>
  <div>
   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
        ...
        <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'edu.register:js_geography_equipment_file:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <JsGeographyEquipmentFileModal @register="registerModal" @success="handleSuccess"></JsGeographyEquipmentFileModal>
  </div>
</template>

<script lang="ts" name="org.eemp.modules.edu.register-jsGeographyEquipmentFile" setup>
  import {ref, computed, unref, onMounted} from 'vue';
  import {BasicTable, useTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import JsGeographyEquipmentFileModal from './components/JsGeographyEquipmentFileModal.vue'
  import {columns, searchFormSchema} from './JsGeographyEquipmentFile.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl, reportOne, batchRevoke, getFillingControlUrl, getTemplateInfoUrl, updateTemplateInfoUrl} from './JsGeographyEquipmentFile.api';
  ...
  const packageName = 'js_geography_equipment_file';
