...
INSERT INTO sys_permission(id, parent_id, name, url, component, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_route, is_leaf, keep_alive, hidden, hide_tab, description, status, del_flag, rule_flag, create_by, create_time, update_by, update_time, internal_or_external) VALUES
   ...
   ,('2025022603428220340', '1666282632293519122', '实验教学统计', '/edu/practice/experimentalTeachingStatisticsList', 'edu/practice/ExperimentalTeachingStatisticsList', NULL, NULL, 0, NULL, '1', 2.50, 0, 'ant-design:file-add-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0)
   ...
   ,('2025021804075560180', '1666282632293519122', '信息教学记载', '/edu/practice/informationTechnologyCourseTeachingList', 'edu/practice/InformationTechnologyCourseTeachingList', NULL, NULL, 0, NULL, '1', 7.00, 0, 'ant-design:desktop-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0)
   ,('2025022811424410300', '1666282632293519122', '信息教学统计', '/edu/practice/informationTechnologyCourseStatisticsList', 'edu/practice/InformationTechnologyCourseStatisticsList', NULL, NULL, 0, NULL, '1', 7.50, 0, 'ant-design:ci-circle-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0)
