...
CREATE TABLE `organization_definition` (
  ...
  `institution_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '学校名称',
...
CREATE TABLE `school_library_basic_info_4` (
  ...
  `first_featured_place_num` int COMMENT '特色读书场所一数量',
  `first_featured_place_area` double COMMENT '特色读书场所一总面积（m2）',
  `second_featured_place_name` varchar(32) COLLATE utf8mb4_general_ci COMMENT '特色读书场所二名称',
  `second_featured_place_num` int COMMENT '特色读书场所二数量',
  `second_featured_place_area` double COMMENT '特色读书场所二总面积（m2）',
...
CREATE TABLE `school_functional_room_info_7` (
  ...
  `first_featured_room_name` varchar(32) COLLATE utf8mb4_general_ci COMMENT '特色功能室一名称',
  `first_featured_room_num` int COMMENT '特色功能室一间数',
  `first_featured_room_area` double COMMENT '特色功能室一面积（m2）',
  `second_featured_room_name` varchar(32) COLLATE utf8mb4_general_ci COMMENT '特色功能室二名称',
  `second_featured_room_num` int COMMENT '特色功能室二间数',
  `second_featured_room_area` double COMMENT '特色功能室二面积（m2）',
  `reported` int DEFAULT NULL COMMENT '上报状态',
  `create_by` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更新人',
...
CREATE TABLE `edu_informatization_equip_info_8` (
  ...
  `student_computer_subtotal` int NOT NULL COMMENT '学生计算机室终端总台数',
  `student_computer_num` int NOT NULL COMMENT '学生计算机配备数',
  `student_cloud_terminal_num` int NOT NULL COMMENT '学生云终端配备数',
  `student_other_terminal_num` int NOT NULL COMMENT '学生其他数字化终端配备数',
  `teacher_computer_subtotal` int NOT NULL COMMENT '教师办公终端总台数',
  `teacher_computer_num` int NOT NULL COMMENT '教师办公计算机配备数',
  `teacher_cloud_terminal_num` int NOT NULL COMMENT '教师办公云终端配备数',
  `teacher_other_terminal_num` int NOT NULL COMMENT '教师办公其他数字化终端配备数',
...
CREATE TABLE `filling_control` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
  `control_type` varchar(18) COLLATE utf8mb4_general_ci NOT NULL COMMENT '填报类型',
  `control_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL COMMENT '填报说明',
...
-- --------------------------------------------------------------
-- Table structure for js_sport_equipment_file
-- --------------------------------------------------------------
DROP TABLE IF EXISTS `js_sport_equipment_file`;
CREATE TABLE `js_sport_equipment_file` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
  `identification_code` varchar(18) COLLATE utf8mb4_general_ci NOT NULL COMMENT '标识代码',
  `register_date` date NOT NULL COMMENT '登记日期',
  `register_file` varchar(120) COLLATE utf8mb4_general_ci NOT NULL COMMENT '登记文件',
...
-- --------------------------------------------------------------
-- Table structure for monthly_doc_of_chemical_hazards
-- --------------------------------------------------------------
DROP TABLE IF EXISTS `monthly_doc_of_chemical_hazards`;
CREATE TABLE `monthly_doc_of_chemical_hazards` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
...
-- --------------------------------------------------------------
-- Table structure for experimental_teaching_plan
-- --------------------------------------------------------------
DROP TABLE IF EXISTS `experimental_teaching_plan`;
...
-- --------------------------------------------------------------
-- Table structure for experimental_teaching_statistics
-- --------------------------------------------------------------
DROP TABLE IF EXISTS `experimental_teaching_statistics`;
CREATE TABLE `experimental_teaching_statistics` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
  `identification_code` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '学校名称',
  `subject` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '实验科目',
  `exact_form` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '实验形式',
  `total_number_of_experiments` int NOT NULL COMMENT '应完成实验（次）',
  `actual_completions` int NOT NULL COMMENT '实际完成实验（次）',
...
CREATE TABLE `information_technology_course_teaching` (
  ...
  `clbum` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '班级',
...
-- --------------------------------------------------------------
-- Table structure for information_technology_course_statistics
-- --------------------------------------------------------------
DROP TABLE IF EXISTS `information_technology_course_statistics`;
CREATE TABLE `information_technology_course_statistics` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
  `identification_code` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '学校名称',
  `start_date` date NOT NULL COMMENT '开始时间',
  `end_date` date NOT NULL COMMENT '结束时间',
  `total_number_of_courses` int NOT NULL COMMENT '课时数',
  `create_by` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '创建人',
  `create_time` datetime DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '更新人',
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
...
-- --------------------------------------------------------------
-- Table structure for fusion_subject_course_statistics
-- --------------------------------------------------------------
DROP TABLE IF EXISTS `fusion_subject_course_statistics`;
CREATE TABLE `fusion_subject_course_statistics` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
  `identification_code` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '学校名称',
  `subject` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '学科',
  `start_date` date NOT NULL COMMENT '开始时间',
...
INSERT INTO `sys_dict_item` (id,dict_id,item_text,item_value,description,sort_order,status,create_by,create_time,update_by,update_time) VALUES
     ...
     ('1703929428887285761',	'1703928685203632130',	'教育信息化 + 教育装备 基础信息',	'01',	NULL,	1,	1,	'admin',	'2023-09-19 08:30:08',	NULL,	NULL),
	 ('1703929810464092162',	'1703928685203632130',	'教育装备管理 - 各学科装备',	'02',	NULL,	2,	1,	'admin',	'2023-09-19 08:31:39',	NULL,	NULL),
	 ('1703929810464098292',	'1703928685203632130',	'危化品安全 - 安全月报表',	'03',	NULL,	3,	1,	'admin',	'2023-11-24 15:31:39',	NULL,	NULL)
	,('1729828718802866178',	'1703928685203632130',	'危化品安全 - 安全责任书',	'04',	NULL,	4,	1,	'admin',	'2023-11-29 19:44:40',	NULL,	NULL)
	,('1729828718802866368',	'1703928685203632130',	'教育资源配置 - 资源配置统计',	'05',	NULL,	5,	1,	'admin',	'2024-10-08 19:44:40',	NULL,	NULL)
	 ;
INSERT INTO sys_dict (id, dict_name, dict_code, description, del_flag, create_by, create_time, update_by, update_time, type, tenant_id, low_app_id) VALUES
    ('1888838976951861249',	'实验形式',	'experimental_form',	NULL,	0,	'admin',	'2025-02-10 14:34:40',	NULL,	NULL,	0,	0,	NULL)
    ;
INSERT INTO sys_dict_item (id, dict_id, item_text, item_value, description, sort_order, status, create_by, create_time, update_by, update_time) VALUES
    ('1888839207365951489',	'1888838976951861249',	'演示实验',	'1',	NULL,	1,	1,	'admin',	'2025-02-10 14:35:35',	NULL,	NULL),
    ('1888839313418928130',	'1888838976951861249',	'分组实验',	'2',	NULL,	2,	1,	'admin',	'2025-02-10 14:36:00',	NULL,	NULL)
    ;
...
INSERT INTO sys_permission (id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) VALUES
    ...
    ('1666281667909779458',	'',	'教育信息化',	'/edu/statistics',	'layouts/RouteView',	1,	'',	NULL,	0,	NULL,	'0',	0.30,	0,	'ant-design:laptop-outlined',	0,	0,	0,	0,	NULL,	'admin',	'2023-06-07 11:11:22',	'admin',	'2023-09-07 20:17:26',	0,	0,	NULL,	0),
    ('1666282632293515265',	'',	'教育装备管理',	'/edu/equipment',	'layouts/RouteView',	1,	'',	NULL,	0,	NULL,	'0',	0.40,	0,	'ant-design:appstore-outlined',	0,	0,	0,	0,	NULL,	'admin',	'2023-06-07 11:15:12',	'admin',	'2023-09-07 20:24:38',	0,	0,	NULL,	0),
    ('1714103540890349560',	'1666282632293515265',	'功能室设施',	'/edu/functionroom',	'layouts/RouteView',	1,	'',	NULL,	1,	NULL,	'0',	8.00,	0,	'ant-design:project-outlined',	0,	0,	0,	0,	NULL,	'admin',	'2024-10-30 10:18:25',	'admin',	'2023-10-17 10:24:17',	0,	0,	NULL,	0),
    ('1714103540890349570',	'1666282632293515265',	'各学科装备',	'/edu/register',	'layouts/RouteView',	1,	'',	NULL,	1,	NULL,	'0',	9.00,	0,	'ant-design:experiment-outlined',	0,	0,	0,	0,	NULL,	'admin',	'2023-10-17 10:18:25',	'admin',	'2023-10-17 10:24:17',	0,	0,	NULL,	0),
    ('1714103540890349576',	'1666282632293515265',	'危化品安全',	'/edu/hazard',	'layouts/RouteView',	1,	'',	NULL,	1,	NULL,	'0',	9.20,	0,	'ant-design:fire-outlined',	0,	0,	0,	0,	NULL,	'admin',	'2023-10-17 10:18:25',	'admin',	'2023-10-17 10:24:17',	0,	0,	NULL,	0),
    ...
    ('1666282632293519122',	'',	'教育装备应用',	'/edu/practice',	'layouts/RouteView',	1,	'',	NULL,	0,	NULL,	'0',	0.60,	0,	'ant-design:car-outlined',	0,	0,	0,	0,	NULL,	'admin',	'2025-02-10 09:15:12',	'admin',	'2025-02-10 20:24:38',	0,	0,	NULL,	0),
...
INSERT INTO sys_permission(id, parent_id, name, url, component, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_route, is_leaf, keep_alive, hidden, hide_tab, description, status, del_flag, rule_flag, create_by, create_time, update_by, update_time, internal_or_external) VALUES
     ('2023060402428380260', '1666281667909779458', '基本情况', '/edu/statistics/eduInformatizationBasicInfo_1List', 'edu/statistics/EduInformatizationBasicInfo_1List', NULL, NULL, 1, NULL, '1', 1.00, 0, 'ant-design:laptop-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-06-04 14:42:26', NULL, NULL, 0),
     ('2023070711112570320', '1666281667909779458', '人员情况', '/edu/statistics/eduInformatizationBasicInfo_2List', 'edu/statistics/EduInformatizationBasicInfo_2List', NULL, NULL, 1, NULL, '1', 2.00, 0, 'ant-design:laptop-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-07 11:11:32', NULL, NULL, 0),
     ('2023070704433360220', '1714103540890349560', '实验设施情况', '/edu/statistics/schoolLabBasicInfo_3List', 'edu/statistics/SchoolLabBasicInfo_3List', NULL, NULL, 1, NULL, '1', 3.00, 0, 'ant-design:project-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-07 16:43:22', NULL, NULL, 0),
     ('2023070705157320330', '1714103540890349560', '图书设施情况', '/edu/statistics/schoolLibraryBasicInfo_4List', 'edu/statistics/SchoolLibraryBasicInfo_4List', NULL, NULL, 1, NULL, '1', 4.00, 0, 'ant-design:project-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-07 17:15:33', NULL, NULL, 0),
     ('2023071505454370430', '1714103540890349560', '体育设施情况', '/edu/statistics/schoolSportRoomInfo_5List', 'edu/statistics/SchoolSportRoomInfo_5List', NULL, NULL, 1, NULL, '1', 5.00, 0, 'ant-design:project-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-15 17:45:43', NULL, NULL, 0),
     ('2023071506100910410', '1714103540890349560', '音美设施情况', '/edu/statistics/schoolMusicArtRoomInfo_6List', 'edu/statistics/SchoolMusicArtRoomInfo_6List', NULL, NULL, 1, NULL, '1', 6.00, 0, 'ant-design:project-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-15 18:10:41', NULL, NULL, 0),
     ('2023071507171810530', '1714103540890349560', '其它设施情况', '/edu/statistics/schoolFunctionalRoomInfo_7List', 'edu/statistics/SchoolFunctionalRoomInfo_7List', NULL, NULL, 1, NULL, '1', 7.00, 0, 'ant-design:project-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-15 19:17:53', NULL, NULL, 0),
     ('2023071507187680160', '1666281667909779458', '配备情况', '/edu/statistics/eduInformatizationEquipInfo_8List', 'edu/statistics/EduInformatizationEquipInfo_8List', NULL, NULL, 1, NULL, '1', 8.00, 0, 'ant-design:laptop-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-07-15 19:18:16', NULL, NULL, 0)
    ,('2023101809294300140', '1714103540890349570', '小学数学', '/edu/register/psMathematicsEquipmentFileList', 'edu/register/PsMathematicsEquipmentFileList', NULL, NULL, 1, NULL, '1', 1.00, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0)
   ,('2023112012371130460', '1714103540890349570', '小学科学', '/edu/register/psScientificEquipmentFileList', 'edu/register/PsScientificEquipmentFileList', NULL, NULL, 0, NULL, '1', 1.10, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0),
    ('2023112012382660480', '1714103540890349570', '小学美术', '/edu/register/psArtEquipmentFileList', 'edu/register/PsArtEquipmentFileList', NULL, NULL, 0, NULL, '1', 1.20, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0),
    ('2023112012397210050', '1714103540890349570', '小学音乐', '/edu/register/psMusicEquipmentFileList', 'edu/register/PsMusicEquipmentFileList', NULL, NULL, 0, NULL, '1', 1.30, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0),
    ('2023112012394190250', '1714103540890349570', '小学体育', '/edu/register/psSportEquipmentFileList', 'edu/register/PsSportEquipmentFileList', NULL, NULL, 0, NULL, '1', 1.40, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0),
    ('2023112012394110390', '1714103540890349570', '初中数学', '/edu/register/jsMathematicsEquipmentFileList', 'edu/register/JsMathematicsEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.00, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0),
    ('2023112012393340530', '1714103540890349570', '初中物理', '/edu/register/jsPhysicsEquipmentFileList', 'edu/register/JsPhysicsEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.10, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0),
    ('2023112012402490060', '1714103540890349570', '初中生物', '/edu/register/jsBiologyEquipmentFileList', 'edu/register/JsBiologyEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.20, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0),
    ('2023112012403930240', '1714103540890349570', '初中化学', '/edu/register/jsChemistryEquipmentFileList', 'edu/register/JsChemistryEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.30, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0),
    ('2023112012403200400', '1714103540890349570', '初中地理', '/edu/register/jsGeographyEquipmentFileList', 'edu/register/JsGeographyEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.40, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0),
    ('2023112012402560550', '1714103540890349570', '初中美术', '/edu/register/jsArtEquipmentFileList', 'edu/register/JsArtEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.50, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0),
    ('2023112012416690100', '1714103540890349570', '初中音乐', '/edu/register/jsMusicEquipmentFileList', 'edu/register/JsMusicEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.60, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0),
    ('2023112012411830230', '1714103540890349570', '初中体育', '/edu/register/jsSportEquipmentFileList', 'edu/register/JsSportEquipmentFileList', NULL, NULL, 0, NULL, '1', 2.70, 0, 'ant-design:experiment-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0)
   ,('2023112211067320490', '1714103540890349576', '安全月报表', '/edu/hazard/monthlyDocOfChemicalHazardsList', 'edu/hazard/MonthlyDocOfChemicalHazardsList', NULL, NULL, 1, NULL, '1', 2.00, 0, 'ant-design:fire-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0)
   ...
   ,('2025021004066860350', '1666282632293519122', '实验教学计划', '/edu/practice/experimentalTeachingPlanList', 'edu/practice/ExperimentalTeachingPlanList', NULL, NULL, 0, NULL, '1', 4.50, 0, 'ant-design:clock-circle-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-10 16:06:35', NULL, NULL, 0)
   ,('2025021211517690100', '1666282632293519122', '实验教学记载', '/edu/practice/experimentalTeachingRecordsList', 'edu/practice/ExperimentalTeachingRecordsList', NULL, NULL, 0, NULL, '1', 2.00, 0, 'ant-design:appstore-add-outlined', 1, 0, 0, 0, 0, NULL, '1', 1, 0, 'admin', '2025-02-12 11:51:10', NULL, NULL, 0)
   ,('2025022603428220340', '1666282632293519122', '实验教学统计', '/edu/practice/experimentalTeachingStatisticsList', 'edu/practice/ExperimentalTeachingStatisticsList', NULL, NULL, 0, NULL, '1', 2.50, 0, 'ant-design:file-add-outlined', 1, 0, 0, 0, 0, NULL, '1', 1, 0, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0)
   ...
   ,('2025021804061710030', '1666282632293519122', '危化品使用', '/edu/practice/hazardousChemicalUseRecordList', 'edu/practice/HazardousChemicalUseRecordList', NULL, NULL, 0, NULL, '1', 4.00, 0, 'ant-design:alert-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0)
   ,('2025021804063630290', '1666282632293519122', '仪器借还记载', '/edu/practice/instrumentBorrowingAndReturningList', 'edu/practice/InstrumentBorrowingAndReturningList', NULL, NULL, 0, NULL, '1', 5.00, 0, 'ant-design:export-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0)
   ,('2025021804061740560', '1666282632293519122', '仪器损坏记载', '/edu/practice/instrumentDamageRecordList', 'edu/practice/InstrumentDamageRecordList', NULL, NULL, 0, NULL, '1', 6.00, 0, 'ant-design:close-square-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0)
   ,('2025021804075560180', '1666282632293519122', '信息教学记载', '/edu/practice/informationTechnologyCourseTeachingList', 'edu/practice/InformationTechnologyCourseTeachingList', NULL, NULL, 0, NULL, '1', 7.00, 0, 'ant-design:desktop-outlined', 1, 0, 0, 0, 0, NULL, '1', 1, 0, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0)
   ,('2025022811424410300', '1666282632293519122', '信息教学统计', '/edu/practice/informationTechnologyCourseStatisticsList', 'edu/practice/InformationTechnologyCourseStatisticsList', NULL, NULL, 0, NULL, '1', 7.50, 0, 'ant-design:ci-circle-outlined', 1, 0, 0, 0, 0, NULL, '1', 1, 0, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0)
   ,('2025021912177920480', '1666282632293519122', '学科融合记载', '/edu/practice/fusionOfSubjectsList', 'edu/practice/FusionOfSubjectsList', NULL, NULL, 0, NULL, '1', 8.00, 0, 'ant-design:block-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0)
   ,('2025022811427050550', '1666282632293519122', '学科融合统计', '/edu/practice/fusionSubjectCourseStatisticsList', 'edu/practice/FusionSubjectCourseStatisticsList', NULL, NULL, 0, NULL, '1', 8.50, 0, 'ant-design:audit-outlined', 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0)
    ;
...
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) VALUES
     ...
     ('2023060402428380267', '2023060402428380260',	'上报教育信息化基本情况统计表（一）',	NULL, NULL,	0, NULL, NULL, 2, 'edu.statistics:edu_informatization_basic_info_1:report',	'1', NULL, 0, NULL,	1, 0, 0, 0,	NULL, 'admin', '2023-09-22 15:58:04', NULL,	NULL, 0, 0,	'1', 0),
     ('2023060402428380268', '2023060402428380260',	'退回教育信息化基本情况统计表（一）',	NULL, NULL,	0, NULL, NULL, 2, 'edu.statistics:edu_informatization_basic_info_1:revoke',	'1', NULL, 0, NULL,	1, 0, 0, 0,	NULL, 'admin', '2023-09-22 15:59:20', NULL,	NULL, 0, 0,	'1', 0),
...
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) VALUES
    ('2023101809294300141', '2023101809294300140', '添加小学数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0, 0, '1', 0),
    ('2023101809294300142', '2023101809294300140', '编辑小学数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0, 0, '1', 0),
    ('2023101809294300143', '2023101809294300140', '删除小学数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0, 0, '1', 0),
    ('2023101809294300144', '2023101809294300140', '批量删除小学数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0, 0, '1', 0),
    ('2023101809294300145', '2023101809294300140', '导出excel_小学数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0, 0, '1', 0),
    ('2023101809294300146', '2023101809294300140', '导入excel_小学数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-18 09:29:14', NULL, NULL, 0, 0, '1', 0),
    ('2023101809294300147',	'2023101809294300140', '上报小学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023101809294300148',	'2023101809294300140', '退回小学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_mathematics_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023101809294300149',	'2023101809294300140', '模板上传_小学数学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_mathematics_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023101809294300150',	'2023101809294300140', '模板下载_小学数学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_mathematics_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0)
   ,('2023112012371130461', '2023112012371130460', '添加小学科学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0, 0, '1', 0),
    ('2023112012371130462', '2023112012371130460', '编辑小学科学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0, 0, '1', 0),
    ('2023112012371130463', '2023112012371130460', '删除小学科学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0, 0, '1', 0),
    ('2023112012371130464', '2023112012371130460', '批量删除小学科学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0, 0, '1', 0),
    ('2023112012371130465', '2023112012371130460', '导出excel_小学科学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0, 0, '1', 0),
    ('2023112012371130466', '2023112012371130460', '导入excel_小学科学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:37:46', NULL, NULL, 0, 0, '1', 0),
    ('2023112012371130467',	'2023112012371130460', '上报科学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012371130468',	'2023112012371130460', '退回科学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_scientific_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012371130469',	'2023112012371130460', '模板上传_小学科学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_scientific_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012371130470',	'2023112012371130460', '模板下载_小学科学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_scientific_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012382660481', '2023112012382660480', '添加小学美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0, 0, '1', 0),
    ('2023112012382660482', '2023112012382660480', '编辑小学美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0, 0, '1', 0),
    ('2023112012382660483', '2023112012382660480', '删除小学美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0, 0, '1', 0),
    ('2023112012382660484', '2023112012382660480', '批量删除小学美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0, 0, '1', 0),
    ('2023112012382660485', '2023112012382660480', '导出excel_小学美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0, 0, '1', 0),
    ('2023112012382660486', '2023112012382660480', '导入excel_小学美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:38:48', NULL, NULL, 0, 0, '1', 0),
    ('2023112012382660487',	'2023112012382660480', '上报美术数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012382660488',	'2023112012382660480', '退回美术数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_art_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012382660489',	'2023112012382660480', '模板上传_小学美术各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_art_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012382660490',	'2023112012382660480', '模板下载_小学美术各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_art_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012397210051', '2023112012397210050', '添加小学音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0, 0, '1', 0),
    ('2023112012397210052', '2023112012397210050', '编辑小学音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0, 0, '1', 0),
    ('2023112012397210053', '2023112012397210050', '删除小学音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0, 0, '1', 0),
    ('2023112012397210054', '2023112012397210050', '批量删除小学音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0, 0, '1', 0),
    ('2023112012397210055', '2023112012397210050', '导出excel_小学音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0, 0, '1', 0),
    ('2023112012397210056', '2023112012397210050', '导入excel_小学音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:05', NULL, NULL, 0, 0, '1', 0),
    ('2023112012397210057',	'2023112012397210050', '上报音乐数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012397210058',	'2023112012397210050', '退回音乐数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_music_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012397210059',	'2023112012397210050', '模板上传_小学音乐各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_music_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012397210060',	'2023112012397210050', '模板下载_小学音乐各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_music_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012394190251', '2023112012394190250', '添加小学体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394190252', '2023112012394190250', '编辑小学体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394190253', '2023112012394190250', '删除小学体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394190254', '2023112012394190250', '批量删除小学体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394190255', '2023112012394190250', '导出excel_小学体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394190256', '2023112012394190250', '导入excel_小学体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:25', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394190257',	'2023112012394190250', '上报体育数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012394190258',	'2023112012394190250', '退回体育数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:ps_sport_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012394190259',	'2023112012394190250', '模板上传_小学体育各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_sport_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012394190260',	'2023112012394190250', '模板下载_小学体育各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:ps_sport_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0)
    ;

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) VALUES
    ('2023112012394110391', '2023112012394110390', '添加初中数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394120392', '2023112012394110390', '编辑初中数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394120393', '2023112012394110390', '删除初中数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394120394', '2023112012394110390', '批量删除初中数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394120395', '2023112012394110390', '导出excel_初中数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394120396', '2023112012394110390', '导入excel_初中数学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:39', NULL, NULL, 0, 0, '1', 0),
    ('2023112012394120397',	'2023112012394110390', '上报数学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012394120398',	'2023112012394110390', '退回数学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_mathematics_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012394120399',	'2023112012394110390', '模板上传_初中数学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_mathematics_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012394120400',	'2023112012394110390', '模板下载_初中数学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_mathematics_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012393340531', '2023112012393340530', '添加初中物理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0, 0, '1', 0),
    ('2023112012393340532', '2023112012393340530', '编辑初中物理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0, 0, '1', 0),
    ('2023112012393340533', '2023112012393340530', '删除初中物理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0, 0, '1', 0),
    ('2023112012393340534', '2023112012393340530', '批量删除初中物理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0, 0, '1', 0),
    ('2023112012393340535', '2023112012393340530', '导出excel_初中物理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0, 0, '1', 0),
    ('2023112012393340536', '2023112012393340530', '导入excel_初中物理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:39:53', NULL, NULL, 0, 0, '1', 0),
    ('2023112012393340537',	'2023112012393340530', '上报物理数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012393340538',	'2023112012393340530', '退回物理数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_physics_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012393340539',	'2023112012393340530', '模板上传_初中物理各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_physics_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012393340540',	'2023112012393340530', '模板下载_初中物理各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_physics_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012402490061', '2023112012402490060', '添加初中生物各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402490062', '2023112012402490060', '编辑初中生物各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402490063', '2023112012402490060', '删除初中生物各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402490064', '2023112012402490060', '批量删除初中生物各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402490065', '2023112012402490060', '导出excel_初中生物各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402490066', '2023112012402490060', '导入excel_初中生物各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:06', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402490067',	'2023112012402490060', '上报生物数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012402490068',	'2023112012402490060', '退回生物数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_biology_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012402490069',	'2023112012402490060', '模板上传_初中生物各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_biology_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012402490070',	'2023112012402490060', '模板下载_初中生物各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_biology_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012403930241', '2023112012403930240', '添加初中化学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403930242', '2023112012403930240', '编辑初中化学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403930243', '2023112012403930240', '删除初中化学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403930244', '2023112012403930240', '批量删除初中化学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403930245', '2023112012403930240', '导出excel_初中化学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403930246', '2023112012403930240', '导入excel_初中化学各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:24', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403930247',	'2023112012403930240', '上报化学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012403930248',	'2023112012403930240', '退回化学数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_chemistry_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012403930249',	'2023112012403930240', '模板上传_初中化学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_chemistry_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012403930250',	'2023112012403930240', '模板下载_初中化学各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_chemistry_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012403200401', '2023112012403200400', '添加初中地理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403200402', '2023112012403200400', '编辑初中地理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403200403', '2023112012403200400', '删除初中地理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403200404', '2023112012403200400', '批量删除初中地理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403200405', '2023112012403200400', '导出excel_初中地理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403200406', '2023112012403200400', '导入excel_初中地理各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:40', NULL, NULL, 0, 0, '1', 0),
    ('2023112012403200407',	'2023112012403200400', '上报地理数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012403200408',	'2023112012403200400', '退回地理数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_geography_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012403200409',	'2023112012403200400', '模板上传_初中地理各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_geography_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012403200410',	'2023112012403200400', '模板下载_初中地理各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_geography_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012402570551', '2023112012402560550', '添加初中美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402570552', '2023112012402560550', '编辑初中美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402570553', '2023112012402560550', '删除初中美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402570554', '2023112012402560550', '批量删除初中美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402570555', '2023112012402560550', '导出excel_初中美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402570556', '2023112012402560550', '导入excel_初中美术各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:40:55', NULL, NULL, 0, 0, '1', 0),
    ('2023112012402570557',	'2023112012402560550', '上报美术数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012402570558',	'2023112012402560550', '退回美术数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_art_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012402570559',	'2023112012402560550', '模板上传_初中美术各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_art_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012402570560',	'2023112012402560550', '模板下载_初中美术各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_art_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012416690101', '2023112012416690100', '添加初中音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0, 0, '1', 0),
    ('2023112012416690102', '2023112012416690100', '编辑初中音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0, 0, '1', 0),
    ('2023112012416690103', '2023112012416690100', '删除初中音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0, 0, '1', 0),
    ('2023112012416690104', '2023112012416690100', '批量删除初中音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0, 0, '1', 0),
    ('2023112012416690105', '2023112012416690100', '导出excel_初中音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0, 0, '1', 0),
    ('2023112012416690106', '2023112012416690100', '导入excel_初中音乐各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:10', NULL, NULL, 0, 0, '1', 0),
    ('2023112012416690107',	'2023112012416690100', '上报音乐数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012416690108',	'2023112012416690100', '退回音乐数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_music_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012416690109',	'2023112012416690100', '模板上传_初中音乐各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_music_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012416690110',	'2023112012416690100', '模板下载_初中音乐各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_music_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012411830231', '2023112012411830230', '添加初中体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0, 0, '1', 0),
    ('2023112012411830232', '2023112012411830230', '编辑初中体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0, 0, '1', 0),
    ('2023112012411830233', '2023112012411830230', '删除初中体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0, 0, '1', 0),
    ('2023112012411830234', '2023112012411830230', '批量删除初中体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0, 0, '1', 0),
    ('2023112012411830235', '2023112012411830230', '导出excel_初中体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0, 0, '1', 0),
    ('2023112012411830236', '2023112012411830230', '导入excel_初中体育各学科装备文件', NULL, NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-20 12:41:23', NULL, NULL, 0, 0, '1', 0),
    ('2023112012411830237',	'2023112012411830230', '上报体育数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012411830238',	'2023112012411830230', '退回体育数学各学科装备文件', NULL,	NULL, 0, NULL, NULL, 2, 'edu.register:js_sport_equipment_file:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112012411830239',	'2023112012411830230', '模板上传_初中体育各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_sport_equipment_file:uploadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:58:35',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112012411830240',	'2023112012411830230', '模板下载_初中体育各学科装备文件',	NULL,	NULL,	0,	NULL,	NULL,	2,	'edu.register:js_sport_equipment_file:downloadTemplate',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-10-24 14:59:15',	NULL,	NULL,	0,	0,	'1',	0)
    ;

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) VALUES
    ('2023112211067320491', '2023112211067320490', '添加实验室安全防护与危化品安全月报表', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0, 0, '1', 0),
    ('2023112211067320492', '2023112211067320490', '编辑实验室安全防护与危化品安全月报表', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0, 0, '1', 0),
    ('2023112211067320493', '2023112211067320490', '删除实验室安全防护与危化品安全月报表', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0, 0, '1', 0),
    ('2023112211067320494', '2023112211067320490', '批量删除实验室安全防护与危化品安全月报表', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0, 0, '1', 0),
    ('2023112211067320495', '2023112211067320490', '导出excel_实验室安全防护与危化品安全月报表', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0, 0, '1', 0),
    ('2023112211067320496', '2023112211067320490', '导入excel_实验室安全防护与危化品安全月报表', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-11-22 11:06:49', NULL, NULL, 0, 0, '1', 0),
    ('2023112211067320497',	'2023112211067320490', '上报实验室安全防护与危化品安全月报表', NULL,	NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:report', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:46:30',	NULL,	NULL,	0,	0,	'1', 0),
    ('2023112211067320498',	'2023112211067320490', '退回实验室安全防护与危化品安全月报表', NULL,	NULL, 0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:revoke', '1', NULL,	0, NULL, 1,	0,	0,	0,	NULL, 'admin',	'2023-10-18 16:47:12',	NULL,	NULL,	0,	0,	'1', 0)
   ,('2023112211067320499',	'2023112211067320490', '模板上传_实验室安全防护与危化品安全月报表',	NULL, NULL,	0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:uploadTemplate', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-24 14:58:35', NULL, NULL, 0, 0, '1',	0),
    ('2023112211067320500',	'2023112211067320490', '模板下载_实验室安全防护与危化品安全月报表',	NULL, NULL,	0, NULL, NULL, 2, 'edu.hazard:monthly_doc_of_chemical_hazards:downloadTemplate', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-10-24 14:59:15', NULL, NULL, 0, 0, '1', 0)
   ...
   ,('2023112905055360297',	'2023112905055350290', '上报安全责任书签订', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:signing_of_security_responsibility:report',	'1', NULL, 0, NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-11-29 17:57:17',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112905055360298',	'2023112905055350290', '退回安全责任书签订', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:signing_of_security_responsibility:revoke',	'1', NULL, 0, NULL,	1,	0,	0,	0,	NULL,	'admin',	'2023-11-29 17:58:11',	NULL,	NULL,	0,	0,	'1',	0),
    ('2023112905055360299',	'2023112905055350290', '模板上传_安全责任书签订', NULL, NULL, 0, NULL, NULL, 2, 'edu.hazard:signing_of_security_responsibility:uploadTemplate',	'1', NULL, 0, NULL,	1, 0, 0, 0,	NULL, 'admin', '2023-11-29 17:59:30', NULL,	NULL,	0,	0,	'1',	0),
...
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) VALUES
    ('2025021004066870351', '2025021004066860350', '添加实验教学计划', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_plan:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-10 16:06:35', NULL, NULL, 0, 0, '1', 0),
    ('2025021004066870352', '2025021004066860350', '编辑实验教学计划', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_plan:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-10 16:06:35', NULL, NULL, 0, 0, '1', 0),
    ('2025021004066870353', '2025021004066860350', '删除实验教学计划', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_plan:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-10 16:06:35', NULL, NULL, 0, 0, '1', 0),
   ...
   ,('2025022603428230341', '2025022603428220340', '添加实验教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_statistics:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0, 0, '1', 0),
    ('2025022603428230342', '2025022603428220340', '编辑实验教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_statistics:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0, 0, '1', 0),
    ('2025022603428230343', '2025022603428220340', '删除实验教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_statistics:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0, 0, '1', 0),
    ('2025022603428230344', '2025022603428220340', '批量删除实验教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_statistics:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0, 0, '1', 0),
    ('2025022603428230345', '2025022603428220340', '导出excel_实验教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_statistics:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0, 0, '1', 0),
    ('2025022603428230346', '2025022603428220340', '导入excel_实验教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:experimental_teaching_statistics:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-26 15:42:34', NULL, NULL, 0, 0, '1', 0)
   ...
   ,('2025021804061710031', '2025021804061710030', '添加危化品使用', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:hazardous_chemical_use_record:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061710032', '2025021804061710030', '编辑危化品使用', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:hazardous_chemical_use_record:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061710033', '2025021804061710030', '删除危化品使用', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:hazardous_chemical_use_record:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061710034', '2025021804061710030', '批量删除危化品使用', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:hazardous_chemical_use_record:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061710035', '2025021804061710030', '导出excel_危化品使用', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:hazardous_chemical_use_record:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061710036', '2025021804061710030', '导入excel_危化品使用', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:hazardous_chemical_use_record:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:03', NULL, NULL, 0, 0, '1', 0)
   ,('2025021804063630291', '2025021804063630290', '添加仪器借还', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_borrowing_and_returning:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0, 0, '1', 0),
    ('2025021804063630292', '2025021804063630290', '编辑仪器借还', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_borrowing_and_returning:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0, 0, '1', 0),
    ('2025021804063630293', '2025021804063630290', '删除仪器借还', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_borrowing_and_returning:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0, 0, '1', 0),
    ('2025021804063630294', '2025021804063630290', '批量删除仪器借还', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_borrowing_and_returning:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0, 0, '1', 0),
    ('2025021804063630295', '2025021804063630290', '导出excel_仪器借还', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_borrowing_and_returning:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0, 0, '1', 0),
    ('2025021804063630296', '2025021804063630290', '导入excel_仪器借还', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_borrowing_and_returning:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:29', NULL, NULL, 0, 0, '1', 0)
   ,('2025021804061740561', '2025021804061740560', '添加仪器损坏', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_damage_record:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061740562', '2025021804061740560', '编辑仪器损坏', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_damage_record:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061740563', '2025021804061740560', '删除仪器损坏', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_damage_record:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061740564', '2025021804061740560', '批量删除仪器损坏', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_damage_record:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061740565', '2025021804061740560', '导出excel_仪器损坏', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_damage_record:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0, 0, '1', 0),
    ('2025021804061740566', '2025021804061740560', '导入excel_仪器损坏', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:instrument_damage_record:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:06:56', NULL, NULL, 0, 0, '1', 0)
   ,('2025021804075570181', '2025021804075560180', '添加信息课教学', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_teaching:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0, 0, '1', 0),
    ('2025021804075570182', '2025021804075560180', '编辑信息课教学', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_teaching:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0, 0, '1', 0),
    ('2025021804075570183', '2025021804075560180', '删除信息课教学', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_teaching:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0, 0, '1', 0),
    ('2025021804075570184', '2025021804075560180', '批量删除信息课教学', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_teaching:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0, 0, '1', 0),
    ('2025021804075570185', '2025021804075560180', '导出excel_信息课教学', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_teaching:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0, 0, '1', 0),
    ('2025021804075570186', '2025021804075560180', '导入excel_信息课教学', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_teaching:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-18 16:07:18', NULL, NULL, 0, 0, '1', 0)
   ,('2025022811424410301', '2025022811424410300', '添加信息教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_statistics:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0, 0, '1', 0),
    ('2025022811424410302', '2025022811424410300', '编辑信息教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_statistics:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0, 0, '1', 0),
    ('2025022811424410303', '2025022811424410300', '删除信息教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_statistics:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0, 0, '1', 0),
    ('2025022811424410304', '2025022811424410300', '批量删除信息教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_statistics:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0, 0, '1', 0),
    ('2025022811424410305', '2025022811424410300', '导出excel_信息教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_statistics:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0, 0, '1', 0),
    ('2025022811424410306', '2025022811424410300', '导入excel_信息教学统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:information_technology_course_statistics:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:30', NULL, NULL, 0, 0, '1', 0)
   ,('2025021912177920481', '2025021912177920480', '添加学科融合', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_of_subjects:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0, 0, '1', 0),
    ('2025021912177920482', '2025021912177920480', '编辑学科融合', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_of_subjects:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0, 0, '1', 0),
    ('2025021912177920483', '2025021912177920480', '删除学科融合', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_of_subjects:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0, 0, '1', 0),
    ('2025021912177920484', '2025021912177920480', '批量删除学科融合', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_of_subjects:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0, 0, '1', 0),
    ('2025021912177920485', '2025021912177920480', '导出excel_学科融合', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_of_subjects:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0, 0, '1', 0),
    ('2025021912177920486', '2025021912177920480', '导入excel_学科融合', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_of_subjects:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-19 12:17:48', NULL, NULL, 0, 0, '1', 0)
   ,('2025022811427050551', '2025022811427050550', '添加学科融合统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_subject_course_statistics:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0, 0, '1', 0),
    ('2025022811427050552', '2025022811427050550', '编辑学科融合统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_subject_course_statistics:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0, 0, '1', 0),
    ('2025022811427050553', '2025022811427050550', '删除学科融合统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_subject_course_statistics:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0, 0, '1', 0),
    ('2025022811427050554', '2025022811427050550', '批量删除学科融合统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_subject_course_statistics:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0, 0, '1', 0),
    ('2025022811427050555', '2025022811427050550', '导出excel_学科融合统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_subject_course_statistics:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0, 0, '1', 0),
    ('2025022811427050556', '2025022811427050550', '导入excel_学科融合统计', NULL, NULL, 0, NULL, NULL, 2, 'edu.practice:fusion_subject_course_statistics:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2025-02-28 11:42:55', NULL, NULL, 0, 0, '1', 0)
    ;

-- 角色权限：系统管理员
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
     ('1666340189662081026',	'f6817f48af4fb3af11b9e8bf182f618b',	'1666281667909779458',	NULL,	'2023-06-07 15:03:55',	'127.0.0.1'),               -- 教育信息化
     ('1666340189666275330',	'f6817f48af4fb3af11b9e8bf182f618b',	'1666282632293515265',	NULL,	'2023-06-07 15:03:55',	'127.0.0.1'),               -- 教育装备管理
     ('1851465487461019650',	'f6817f48af4fb3af11b9e8bf182f618b',	'1714103540890349560',	NULL,	'2024-10-30 11:25:45',	'127.0.0.1'),               -- 功能室设施
     ('1664959650845630465',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023060312357030190',	NULL,	'2023-06-03 19:38:09',	'127.0.0.1'),               -- 学校管理
     ...
     ('1677247001298952194',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023070704433360220',	NULL,	'2023-07-07 17:23:42',	'127.0.0.1'),               -- 中小学实验室基本情况统计表（三）
     ...
     ('1678202210594512898',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023070705157320330',	NULL,	'2023-07-10 08:39:21',	'127.0.0.1'),               -- 中小学图书室（馆）基本情况统计表（四）
     ...
     ('1704051501858787329',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023091403567720490',	NULL,	'2023-09-19 16:35:12',	'127.0.0.1'),               -- 填报控制
     ('1704051501871370241',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023091403567720491',	NULL,	'2023-09-19 16:35:12',	'127.0.0.1'),
     ('1704051501875564545',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023091403567720492',	NULL,	'2023-09-19 16:35:12',	'127.0.0.1'),
    ...
    ,('1714115193287618561',	'f6817f48af4fb3af11b9e8bf182f618b',	'1714103540890349570',	NULL,	'2023-10-17 11:04:43',	'127.0.0.1'),               -- 各学科装备
     ('1714115193296007169',	'f6817f48af4fb3af11b9e8bf182f618b',	'2023101809294300141',	NULL,	'2023-10-17 11:04:43',	'127.0.0.1'),               -- 小学数学各学科装备文件
    ...
    ,('1889126312795308034',	'f6817f48af4fb3af11b9e8bf182f618b',	'1666282632293519122',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),               -- 教育装备应用
     ('1889126312816279553',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066860350',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),               -- 实验教学计划
     ('1889126312820473857',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066870351',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),
     ('1889126312824668162',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066870352',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),
     ('1889126312824668163',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066870353',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),
     ('1889126312833056770',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066870354',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),
     ('1889126312833056771',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066870355',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1'),
     ('1889126312837251074',	'f6817f48af4fb3af11b9e8bf182f618b',	'2025021004066870356',	NULL,	'2025-02-11 09:36:26',	'127.0.0.1')
...
INSERT INTO `edu_informatization_basic_info_1` (`id`, `identification_code`, `fill_date`, `teacher_count`, `student_count`, `room_count`, `classroom_count`, `student_desk_count`, `connected_room_count`, `has_a_central_server_room`, `teaching_resource_capacity`, `create_by`, `create_time`, `update_by`, `update_time`, `sys_org_code`) VALUES
     ...
     ('1678627997017591801',	'5262003028',	'2022-12-21',	228,	3370,	100,	84,	5000,	70,	'1',	0,	'admin_syz',	'2023-07-11 12:51:17',	NULL,	NULL,	NULL),
     ('1678627997017591805',	'5262003028',	'2023-06-30',	230,	3380,	100,	84,	5000,	70,	'1',	0,	'admin_syz',	'2023-07-11 12:51:17',	NULL,	NULL,	NULL),
     ('1678627997017591809',	'5262003028',	'2023-07-11',	237,	3390,	100,	84,	5000,	70,	'1',	0,	'admin_syz',	'2023-07-11 12:51:17',	NULL,	NULL,	NULL),
...
INSERT INTO `school_lab_basic_info_3` (`id`, `identification_code`, `fill_date`, `physics_lab_room_num`, `physics_lab_area`, `physics_lab_bench_num`, `physics_equipment_room_num`, `physics_equipment_room_area`, `physics_equipment_cabinet_num`, `physics_equipment_bench_num`, `biochemistry_lab_room_num`, `biochemistry_lab_area`, `biochemistry_lab_bench_num`, `biochemistry_equip_room_num`, `biochemistry_equip_room_area`, `biochemistry_equip_cabinet_num`, `biochemistry_equip_bench_num`, `science_lab_room_num`, `science_lab_area`, `science_lab_bench_num`, `science_equipment_room_num`, `science_equipment_room_area`, `science_equipment_cabinet_num`, `science_equipment_bench_num`, `hazardous_chemical_cabinet_num`, `full_time_lab_technician_num`, `part_time_lab_technician_num`, `create_by`, `create_time`, `update_by`, `update_time`, `sys_org_code`) VALUES
    ('1694609617356795905',	'3142007024',	'2023-08-24',	1,	60,	12,	1,	20,	25,	6,	1,	60,	12,	1,	20,	18,	6,	0,	0,	0,	0,	0,	0,	0,	4,	1,	0,	'admin_bbzx',	'2023-08-24 15:16:32',	NULL,	NULL,	NULL),
    ('1694610747411345410',	'5262003028',	'2023-08-24',	3,	102,	70,	1,	43,	28,	1,	6,	102,	112,	2,	43,	80,	4,	2,	102,	60,	1,	43,	5,	1,	7,	9,	0,	'admin_syz',	'2023-08-24 15:21:01',	NULL,	NULL,	NULL);
...
INSERT INTO `edu_informatization_equip_info_8` (`id`, `identification_code`, `fill_date`, `classes_num`, `student_computer_subtotal`, `student_computer_num`, `student_cloud_terminal_num`, `student_other_terminal_num`, `teacher_computer_subtotal`, `teacher_computer_num`, `teacher_cloud_terminal_num`, `teacher_other_terminal_num`, `all_in_one_machine_num`, `computer_plus_tv_num`, `video_visualizer_num`, `class_num_without_equip`, `is_the_backbone_gigabit`, `has_a_dedicated_ap_network`, `wireless_ap_num`, `campus_surveillance_camera_num`, `campus_surveillance_dvr_num`, `surveillance_retention_time`, `create_by`, `create_time`, `update_by`, `update_time`, `sys_org_code`) VALUES
    ('1680555625727340540',	'1232002606',	'2022-03-18',	16,	1,  1,  0,	0,	30,	24,	26,	30,	15,	0,	0,	0,	'0',	'0',	0,	52,	2,	30,	'admin_jgyey',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340542',	'1232002606',	'2022-07-03',	12,	2,	1,	1,  0,	30,	24,	26,	30,	15,	0,	0,	0,	'0',	'0',	0,	52,	2,	30,	'admin_jgyey',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340545',	'1232002606',	'2023-03-21',	13,	3,	1,	1,  1,	30,	24,	26,	30,	15,	0,	0,	0,	'0',	'0',	0,	52,	2,	30,	'admin_jgyey',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340546',	'1232002606',	'2023-07-16',	15,	4,	2,	1,  1,	30,	24,	26,	30,	15,	0,	0,	0,	'0',	'0',	0,	52,	2,	30,	'admin_jgyey',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340547',	'2142009669',	'2022-01-16',	23,	61, 61,	61,	61,	15,	5,	10,	15,	26,	9,	0,	0,	'1',	'0',	0,	48,	3,	30,	'admin_bbxx',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340548',	'2142009669',	'2022-10-05',	25,	61, 61,	61,	61,	15,	5,	10,	15,	26,	9,	0,	0,	'1',	'0',	0,	48,	3,	30,	'admin_bbxx',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340549',	'2142009669',	'2023-05-23',	25,	61, 61,	61,	61,	15,	5,	10,	15,	26,	9,	0,	0,	'1',	'0',	0,	48,	3,	30,	'admin_bbxx',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680555625727340550',	'2142009669',	'2023-07-16',	25,	61, 61,	61,	61,	15,	5,	10,	15,	26,	9,	0,	0,	'1',	'0',	0,	48,	3,	30,	'admin_bbxx',	'2023-07-16 20:30:59',	NULL,	NULL,	NULL),
    ('1680576743020404732',	'3142007024',	'2022-05-16',	18,	54, 54,	54,	0,	92,	0,	90,	0,	21,	21,	21,	0,	'1',	'1',	5,	48,	4,	30,	'admin_bbzx',	'2023-07-16 21:54:54',	NULL,	NULL,	NULL),
    ('1680576743020404733',	'3142007024',	'2022-09-25',	19,	54, 54,	54,	0,	92,	0,	90,	0,	21,	21,	21,	0,	'1',	'1',	5,	48,	4,	30,	'admin_bbzx',	'2023-07-16 21:54:54',	NULL,	NULL,	NULL),
    ('1680576743020404736',	'3142007024',	'2023-04-12',	20,	54, 54,	54,	0,	92,	0,	90,	0,	21,	21,	21,	0,	'1',	'1',	5,	48,	4,	30,	'admin_bbzx',	'2023-07-16 21:54:54',	NULL,	NULL,	NULL),
    ('1680576743020404738',	'3142007024',	'2023-07-16',	21,	54, 54,	54,	0,	92,	0,	90,	0,	21,	21,	21,	0,	'1',	'1',	5,	48,	4,	30,	'admin_bbzx',	'2023-07-16 21:54:54',	NULL,	NULL,	NULL),
    ('1680579141503787001',	'2142004708',	'2022-02-27',	1,	35, 35,	0,	35,	6,	2,	3,	1,	6,	0,	0,	2,	'1',	'0',	0,	7,	1,	30,	'admin_zzxx',	'2023-07-16 22:04:26',	NULL,	NULL,	NULL),
    ('1680579141503787003',	'2142004708',	'2022-03-05',	2,	35, 35,	0,	35,	6,	2,	3,	1,	6,	0,	0,	2,	'1',	'0',	0,	7,	1,	30,	'admin_zzxx',	'2023-07-16 22:04:26',	NULL,	NULL,	NULL),
    ('1680579141503787006',	'2142004708',	'2022-11-08',	3,	35, 35,	0,	35,	6,	2,	3,	1,	6,	0,	0,	2,	'1',	'0',	0,	7,	1,	30,	'admin_zzxx',	'2023-07-16 22:04:26',	NULL,	NULL,	NULL),
    ('1680579141503787007',	'2142004708',	'2023-03-26',	4,	35, 35,	0,	35,	6,	2,	3,	1,	6,	0,	0,	2,	'1',	'0',	0,	7,	1,	30,	'admin_zzxx',	'2023-07-16 22:04:26',	NULL,	NULL,	NULL),
    ('1680579141503787008',	'2142004708',	'2023-06-07',	5,	35, 35,	0,	35,	6,	2,	3,	1,	6,	0,	0,	2,	'1',	'0',	0,	7,	1,	30,	'admin_zzxx',	'2023-07-16 22:04:26',	NULL,	NULL,	NULL),
    ('1680579141503787010',	'2142004708',	'2023-07-16',	6,	35, 35,	0,	35,	6,	2,	3,	1,	6,	0,	0,	2,	'1',	'0',	0,	7,	1,	30,	'admin_zzxx',	'2023-07-16 22:04:26',	NULL,	NULL,	NULL);
...
INSERT INTO `sys_role_index` (`id`, `role_code`, `url`, `component`, `is_route`, `priority`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `sys_org_code`) VALUES
    ...
    ('1727852049709711361',	'other_school',	'/edu/HomePage',	'/edu/HomePage',	1,	0,	'1',	'admin',	'2023-11-24 08:50:05',	NULL,	NULL,	'A01')
    ;

-- 角色权限：装备中心 - 统计分析
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
    ('1698324007239176193',	'1666258199763877889',	'9502685863ab87f0ad1134142788a385',	NULL,	'2023-09-03 21:16:11',	'127.0.0.1'),       -- 首页
    ('1698588287901581313',	'1666258199763877889',	'1592114772665790465',	NULL,	'2023-09-04 14:46:21',	'127.0.0.1');                   -- 用户可修改密码
...
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
     ...
     ('1851467585665789953',	'1666258199747100674',	'1714103540890349560',	NULL,	'2024-10-30 11:34:06',	'127.0.0.1'),               -- 功能室设施
...
--     ('1680407502270889990',	'1666258199747100674',	'2023071507187680166',	NULL,	'2023-07-16 10:42:24',	'127.0.0.1'),
    ...
    ,('1892766935809159169',	'1666258199747100674',	'2025021004066870355',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1889845561969012738',	'1666258199747100674',	'2025021211517690100',	NULL,	'2025-02-13 09:14:28',	'127.0.0.1')                -- 实验教学记载
    ,('1892766935821742082',	'1666258199747100674',	'2025021211517690105',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1894664804568895489',	'1666258199747100674',	'2025022603428220340',	NULL,	'2025-02-26 16:24:25',	'127.0.0.1'),               -- 实验教学统计
     ('1894664804573089793',	'1666258199747100674',	'2025022603428230345',	NULL,	'2025-02-26 16:24:25',	'127.0.0.1')
    ,('1890342693306015745',	'1666258199747100674',	'2025021400411520210',	NULL,	'2025-02-14 18:09:54',	'127.0.0.1')                -- 危化品登记
    ,('1892766935825936386',	'1666258199747100674',	'2025021400411530215',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1891785265253658625',	'1666258199747100674',	'2025021804061710030',	NULL,	'2025-02-18 17:42:10',	'127.0.0.1')                -- 危化品使用
    ,('1892766935825936387',	'1666258199747100674',	'2025021804061710035',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1891800068923830273',	'1666258199747100674',	'2025021804063630290',	NULL,	'2025-02-18 18:40:59',	'127.0.0.1')                -- 仪器借还
    ,('1892766935825936388',	'1666258199747100674',	'2025021804063630295',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1891826556914065409',	'1666258199747100674',	'2025021804061740560',	NULL,	'2025-02-18 20:26:14',	'127.0.0.1')                -- 仪器损坏
    ,('1892766935825936389',	'1666258199747100674',	'2025021804061740565',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1892046067583832066',	'1666258199747100674',	'2025021804075560180',	NULL,	'2025-02-19 10:58:30',	'127.0.0.1')                -- 信息教学记载
    ,('1892766935825936390',	'1666258199747100674',	'2025021804075570185',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1895357989162979329',	'1666258199747100674',	'2025022811424410300',	NULL,	'2025-02-28 14:18:53',	'127.0.0.1'),               -- 信息教学统计
     ('1895357989167173634',	'1666258199747100674',	'2025022811424410305',	NULL,	'2025-02-28 14:18:53',	'127.0.0.1')
    ,('1892117915285786626',	'1666258199747100674',	'2025021912177920480',	NULL,	'2025-02-19 15:44:00',	'127.0.0.1')                -- 学科融合记载
    ,('1892766935830130689',	'1666258199747100674',	'2025021912177920485',	NULL,	'2025-02-21 10:42:58',	'127.0.0.1')
    ,('1895377276724494338',	'1666258199747100674',	'2025022811427050555',	NULL,	'2025-02-28 15:35:32',	'127.0.0.1'),               -- 学科融合统计
     ('1895377276707717121',	'1666258199747100674',	'2025022811427050550',	NULL,	'2025-02-28 15:35:32',	'127.0.0.1')
     ;

-- 角色权限：装备中心 – 装备管理检查
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
     ('1698605380663459842',	'1698527018892869633',	'1666282632293515265',	NULL,	'2023-09-04 15:54:16',	'127.0.0.1')                -- 教育装备管理
    ,('1714117993681793025',	'1698527018892869633',	'1714103540890349570',	NULL,	'2023-10-17 11:15:51',	'127.0.0.1'),               -- 各学科装备
--     ('1714117993685987331',	'1698527018892869633',	'2023101809294300141',	NULL,	'2023-10-17 11:15:51',	'127.0.0.1'),               -- 小学数学各学科装备文件
...
--     ('1714117993685987336',	'1698527018892869633',	'2023101809294300146',	NULL,	'2023-10-17 11:15:51',	'127.0.0.1'),
    ...
    ,('1727217595599519746',	'1698527018892869633',	'1714103540890349576',	NULL,	'2023-11-22 14:49:00',	'127.0.0.1'),               -- 危化品安全
     ('1727974536076554242',	'1698527018892869633',	'2023112211067320497',	NULL,	'2023-11-24 16:56:48',	'127.0.0.1'),               -- 月报表归档 上报
     ('1727974536055582722',	'1698527018892869633',	'2023112211067320498',	NULL,	'2023-11-24 16:56:48',	'127.0.0.1')
    ...
    ,('1729809340753436674',	'1698527018892869633',	'2023112905055360297',	NULL,	'2023-11-29 18:27:40',	'127.0.0.1'),               -- 安全责任书签订 上报
     ('1729809340761825282',	'1698527018892869633',	'2023112905055360298',	NULL,	'2023-11-29 18:27:40',	'127.0.0.1'),
     ('1729809340766019585',	'1698527018892869633',	'2023112905055360299',	NULL,	'2023-11-29 18:27:40',	'127.0.0.1'),
     ('1729809340778602497',	'1698527018892869633',	'2023112905055360300',	NULL,	'2023-11-29 18:27:40',	'127.0.0.1')
    ,('1843631128213393409',	'1698527018892869633',	'1666282632293515286',	NULL,	'2024-10-08 20:34:49',	'127.0.0.1'),               -- 教育资源配置
     ('1843631128225976322',	'1698527018892869633',	'2024100815260010018',	NULL,	'2024-10-08 20:34:49',	'127.0.0.1'),               -- 资源配置统计
     ('1843631128230170625',	'1698527018892869633',	'2024100815260010019',	NULL,	'2024-10-08 20:34:49',	'127.0.0.1'),
     ('1843631128230170626',	'1698527018892869633',	'2024100815260010020',	NULL,	'2024-10-08 20:34:49',	'127.0.0.1'),
     ('1843631128234364930',	'1698527018892869633',	'2024100815260010017',	NULL,	'2024-10-08 20:34:49',	'127.0.0.1')
     ;
...
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
    ...
    ('1851470525088559105',	'1698620226046316546',	'1714103540890349560',	NULL,	'2024-10-30 11:45:46',	'127.0.0.1'),               -- 功能室设施
    ...
    ('1725423090785308674',	'1698620226046316546',	'1714103540890349570',	NULL,	'2023-11-17 15:58:16',	'127.0.0.1'),               -- 各学科装备
    ('1727223685393383425',	'1698620226046316546',	'1714103540890349576',	NULL,	'2023-11-22 15:13:12',	'127.0.0.1')                -- 危化品安全
   ...
   ,('1894664370374545410',	'1698620226046316546',	'2025022603428220340',	NULL,	'2025-02-26 16:22:42',	'127.0.0.1')                -- 实验教学统计
   ,('1890343259054710786',	'1698620226046316546',	'2025021400411520210',	NULL,	'2025-02-14 18:12:08',	'127.0.0.1')                -- 危化品登记
   ,('1891785641507893249',	'1698620226046316546',	'2025021804061710030',	NULL,	'2025-02-18 17:43:39',	'127.0.0.1')                -- 危化品使用
   ,('1891800205691695106',	'1698620226046316546',	'2025021804063630290',	NULL,	'2025-02-18 18:41:32',	'127.0.0.1')                -- 仪器借还
   ,('1891826467508281346',	'1698620226046316546',	'2025021804061740560',	NULL,	'2025-02-18 20:25:53',	'127.0.0.1')                -- 仪器损坏
   ,('1892045984209457154',	'1698620226046316546',	'2025021804075560180',	NULL,	'2025-02-19 10:58:10',	'127.0.0.1')                -- 信息教学记载
   ,('1895357804512940034',	'1698620226046316546',	'2025022811424410300',	NULL,	'2025-02-28 14:18:09',	'127.0.0.1')                -- 信息教学统计
   ,('1892117813993345025',	'1698620226046316546',	'2025021912177920480',	NULL,	'2025-02-19 15:43:35',	'127.0.0.1')                -- 学科融合记载
   ,('1895377112647516162',	'1698620226046316546',	'2025022811427050550',	NULL,	'2025-02-28 15:34:53',	'127.0.0.1')                -- 学科融合统计
    ;
...
--     ('1680408415920324619',	'1666258199679991810',	'2023071507187680166',	NULL,	'2023-07-16 10:46:01',	'127.0.0.1'),
     ...
     ('1851470993739116545',	'1666258199679991810',	'1714103540890349560',	NULL,	'2024-10-30 11:47:38',	'127.0.0.1'),               -- 功能室设施
     ('1727221859180838913',	'1666258199679991810',	'1714103540890349576',	NULL,	'2023-11-22 15:05:56',	'127.0.0.1'),               -- 危化品安全
     ('1727221859193421826',	'1666258199679991810',	'2023112211067320491',	NULL,	'2023-11-22 15:05:56',	'127.0.0.1'),               -- 月报表归档
     ('1727221859197616129',	'1666258199679991810',	'2023112211067320492',	NULL,	'2023-11-22 15:05:56',	'127.0.0.1')
, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
   ...
   ,('1894663645951135746',	'2025022603428220340',	'学校仅能看到本校的数据#实验教学统计',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-26 16:19:49',	'admin',	NULL,	NULL)
   ,('1890341355495006210',	'2025021400411520210',	'学校仅能看到本校的数据#危化品登记',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-14 18:04:34',	'admin',	NULL,	NULL)
   ,('1891780116443508737',	'2025021804061710030',	'学校仅能看到本校的数据#危化品使用',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-18 17:21:42',	'admin',	NULL,	NULL)
   ,('1891799194252062722',	'2025021804063630290',	'学校仅能看到本校的数据#仪器借还',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-18 18:37:30',	'admin',	NULL,	NULL)
   ,('1891825589657231362',	'2025021804061740560',	'学校仅能看到本校的数据#仪器损坏',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-18 20:22:24',	'admin',	NULL,	NULL)
   ,('1892045190479368193',	'2025021804075560180',	'学校仅能看到本校的数据#信息教学记载',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-19 10:55:00',	'admin',	NULL,	NULL)
   ,('1895358872286269442',	'2025022811424410300',	'学校仅能看到本校的数据#信息教学统计',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-28 14:22:24',	'admin',	NULL,	NULL)
   ,('1892116924746371074',	'2025021912177920480',	'学校仅能看到本校的数据#学科融合记载',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-19 15:40:03',	'admin',	NULL,	NULL)
   ,('1895376191242813442',	'2025022811427050550',	'学校仅能看到本校的数据#学科融合统计',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2025-02-28 15:31:13',	'admin',	NULL,	NULL)
    ;
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
   ...
   ,('1894665155925741570',	'1666258199679991810',	'2025022603428220340',	'1894663645951135746',	'2025-02-26 16:25:49',	'127.0.0.1'),                   -- 高中 & #实验教学统计
    ('1894665035582771202',	'1666258199700963330',	'2025022603428220340',	'1894663645951135746',	'2025-02-26 16:25:20',	'127.0.0.1'),                   -- 初中
    ('1894664902904352770',	'1666258199717740546',	'2025022603428220340',	'1894663645951135746',	'2025-02-26 16:24:49',	'127.0.0.1')                    -- 小学
   ...
   ,('1891785971159216130',	'1666258199679991810',	'2025021804061710030',	'1891780116443508737',	'2025-02-18 17:44:58',	'127.0.0.1'),                   -- 高中 & #危化品使用
    ('1891786861379268609',	'1666258199700963330',	'2025021804061710030',	'1891780116443508737',	'2025-02-18 17:48:30',	'127.0.0.1'),                   -- 初中
    ('1891787686377893890',	'1666258199717740546',	'2025021804061710030',	'1891780116443508737',	'2025-02-18 17:51:47',	'127.0.0.1')                    -- 小学
   ,('1891801300484730882',	'1666258199679991810',	'2025021804063630290',	'1891799194252062722',	'2025-02-18 18:45:53',	'127.0.0.1'),                   -- 高中 & #仪器借还
, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
   ...
   ,('1727970725555564546',	'2023112211067320490',	'学校仅能看到本校的数据#危月',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2023-11-24 16:41:40',	'admin',	NULL,	NULL)
   ,('1729803317577703425',	'2023112905055350290',	'学校仅能看到本校的数据#责签',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2023-11-29 18:03:43',	'admin',	NULL,	NULL)
   ,('1729803317577703686',	'2024100815260010010',	'学校仅能看到本校的数据#资配',	'createBy',	'=',	'#{sys_user_code}',	'1',	'2024-10-08 18:03:43',	'admin',	NULL,	NULL)
    ;
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
    ...
    ('1851434959328407553',	'1666258199717740546',	'2023112211067320490',	'1727970725555564546',	'2024-10-30 09:24:27',	'127.0.0.1'),           -- 小学 & 月报表归档
    ('1851434959311630337',	'1666258199717740546',	'2023112905055350290',	'1729803317577703425',	'2024-10-30 09:24:27',	'127.0.0.1'),             -- 安全责任书签订
    ('1843628105365917697',	'1666258199717740546',	'2024100815260010010',	'1729803317577703686',	'2024-10-08 20:22:48',	'127.0.0.1'),           -- 小学 & 资源配置统计
   ...
   ,('1727220339668385794',	'1666258199700963330',	'2023112211067320490',	'1727970725555564546',	'2023-11-22 14:59:54',	'127.0.0.1'),           -- 初中 & 月报表归档
    ('1729811540955291650',	'1666258199700963330',	'2023112905055350290',	'1729803317577703425',	'2023-11-29 18:36:24',	'127.0.0.1'),             -- 安全责任书签订
    ('1843624420564996097',	'1666258199700963330',	'2024100815260010010',	'1729803317577703686',	'2024-10-08 20:08:09',	'127.0.0.1'),           -- 初中 & 资源配置统计
    ('1727221859193421825',	'1666258199679991810',	'2023112211067320490',	'1727970725555564546',	'2023-11-22 15:05:56',	'127.0.0.1')            -- 高中 & 月报表归档
   ,('1729813611968389122',	'1666258199679991810',	'2023112905055350290',	'1729803317577703425',	'2023-11-29 18:44:38',	'127.0.0.1')              -- 安全责任书签订
    ;
...
INSERT INTO `sys_permission_data_rule` (`id`, `permission_id`, `rule_name`, `rule_column`, `rule_conditions`, `rule_value`, `status`, `create_time`, `create_by`, `update_time`, `update_by`) VALUES
   ...
   ,('1727970973434736642',	'2023112211067320490',	'电教中心仅能看到学校上报的装备文件#危月',	'reported',	'=',	'1',	'1',	'2023-11-24 16:42:39',	'admin',	NULL,	NULL)
   ,('1729803477405851649',	'2023112905055350290',	'电教中心仅能看到学校上报的装备文件#责签',	'reported',	'=',	'1',	'1',	'2023-11-29 18:04:22',	'admin',	NULL,	NULL)
   ,('1729803477405851686',	'2024100815260010010',	'电教中心仅能看到学校上报的装备文件#资配',	'reported',	'=',	'1',	'1',	'2024-10-08 18:04:22',	'admin',	NULL,	NULL)
    ;
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
   ...
   ,('1727217595637268482',	'1698527018892869633',	'2023112211067320490',	'1727970973434736642',	'2023-11-22 14:49:00',	'127.0.0.1')                      -- 危化品月报表
   ,('1729809340669550594',	'1698527018892869633',	'2023112905055350290',	'1729803477405851649',	'2023-11-29 18:27:40',	'127.0.0.1')                      -- 安全责任书签订
   ,('1843631128221782018',	'1698527018892869633',	'2024100815260010010',	'1729803477405851686',	'2024-10-08 20:34:49',	'127.0.0.1')                      -- 资源配置统计
   ,('1843633108264620034',	'1698620226046316546',	'1729802960269139986',	NULL,	'2024-10-08 20:42:41',	'127.0.0.1')                -- 资源配置统计
    ;

-- 统一授权字段列显示控制（优化利用授权标识来整合权限）
INSERT INTO `sys_permission` (`id`, `parent_id`, `name`, `url`, `component`, `is_route`, `component_name`, `redirect`, `menu_type`, `perms`, `perms_type`, `sort_no`, `always_show`, `icon`, `is_leaf`, `keep_alive`, `hidden`, `hide_tab`, `description`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `rule_flag`, `status`, `internal_or_external`) VALUES
    ('1889247416759279618',	'9502685863ab87f0ad1134142788a385',	'统一授权学校名称列展示',	NULL,	NULL,	0,	NULL,	NULL,	2,	'auth-column-school-name',	'1',	NULL,	0,	NULL,	1,	0,	0,	0,	NULL,	'admin',	'2025-02-11 17:37:39',	NULL,	NULL,	0,	0,	'1',	0)
    ;
INSERT INTO `sys_role_permission` (`id`, `role_id`, `permission_id`, `data_rule_ids`, `operate_date`, `operate_ip`) VALUES
    ('1889247725774626818',	'f6817f48af4fb3af11b9e8bf182f618b',	'1889247416759279618',	NULL,	'2025-02-11 17:38:53',	'127.0.0.1'),           -- 系统管理员 & 学校名称
    ('1889250911528869889',	'1666258199763877889',	'1889247416759279618',	NULL,	'2025-02-11 17:51:33',	'127.0.0.1')                        -- 装备中心统计分析 & 学校名称
    ;
...
-- ----------------------------
DROP TABLE IF EXISTS `edu_equipment_req_template`;
CREATE TABLE `edu_equipment_req_template` (
  `id` varchar(36) COLLATE utf8mb4_general_ci NOT NULL,
  `file_date` date DEFAULT NULL COMMENT '文件日期',
  `file_name` varchar(256) COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件名字',
...
-- 注意：该页面对应的前台目录为views/eduequipmentreqtemplate文件夹下
-- 如果你想更改到其他目录，请修改sql中component字段对应的值


INSERT INTO sys_permission(id, parent_id, name, url, component, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_route, is_leaf, keep_alive, hidden, hide_tab, description, status, del_flag, rule_flag, create_by, create_time, update_by, update_time, internal_or_external)
VALUES ('2023082908316370490', NULL, '教学器材配备标准模板', '/edu/eduequipmentreqtemplate/eduEquipmentReqTemplateList', '/edu/eduequipmentreqtemplate/EduEquipmentReqTemplateList', NULL, NULL, 0, NULL, '1', 0.00, 0, NULL, 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0);

-- 权限控制sql
-- 新增
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082908316370491', '2023082908316370490', '添加教学器材配备标准模板', NULL, NULL, 0, NULL, NULL, 2, 'eduequipmentreqtemplate:edu_equipment_req_template:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0, 0, '1', 0);
-- 编辑
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082908316370492', '2023082908316370490', '编辑教学器材配备标准模板', NULL, NULL, 0, NULL, NULL, 2, 'eduequipmentreqtemplate:edu_equipment_req_template:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0, 0, '1', 0);
-- 删除
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082908316370493', '2023082908316370490', '删除教学器材配备标准模板', NULL, NULL, 0, NULL, NULL, 2, 'eduequipmentreqtemplate:edu_equipment_req_template:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0, 0, '1', 0);
-- 批量删除
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082908316370494', '2023082908316370490', '批量删除教学器材配备标准模板', NULL, NULL, 0, NULL, NULL, 2, 'eduequipmentreqtemplate:edu_equipment_req_template:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0, 0, '1', 0);
-- 导出excel
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082908316370495', '2023082908316370490', '导出excel_教学器材配备标准模板', NULL, NULL, 0, NULL, NULL, 2, 'eduequipmentreqtemplate:edu_equipment_req_template:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0, 0, '1', 0);
-- 导入excel
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082908316370496', '2023082908316370490', '导入excel_教学器材配备标准模板', NULL, NULL, 0, NULL, NULL, 2, 'eduequipmentreqtemplate:edu_equipment_req_template:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-29 08:31:49', NULL, NULL, 0, 0, '1', 0);

-- ----------------------------
-- Table structure for edu_primary_art_equipment
-- ----------------------------
DROP TABLE IF EXISTS `edu_primary_art_equipment`;
CREATE TABLE `edu_primary_art_equipment` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `school` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '学校',
  `file_date` date DEFAULT NULL COMMENT '文件日期',
  `file_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '文件名字',
  `file_size` int DEFAULT NULL COMMENT '文件大小',
  `file_data` longblob NOT NULL COMMENT '文件数据',
...
-- 注意：该页面对应的前台目录为views/primaryartequipment文件夹下
-- 如果你想更改到其他目录，请修改sql中component字段对应的值


INSERT INTO sys_permission(id, parent_id, name, url, component, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_route, is_leaf, keep_alive, hidden, hide_tab, description, status, del_flag, rule_flag, create_by, create_time, update_by, update_time, internal_or_external)
VALUES ('2023082703451490310', NULL, '小学美术教学器材配备标准', '/edu/primaryartequipment/eduPrimaryArtEquipmentList', '/edu/primaryartequipment/EduPrimaryArtEquipmentList', NULL, NULL, 0, NULL, '1', 0.00, 0, NULL, 1, 0, 0, 0, 0, NULL, '1', 0, 0, 'admin', '2023-08-27 15:45:31', NULL, NULL, 0);

-- 权限控制sql
-- 新增
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082703451490311', '2023082703451490310', '添加小学美术教学器材配备标准', NULL, NULL, 0, NULL, NULL, 2, 'primaryartequipment:edu_primary_art_equipment:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-27 15:45:31', NULL, NULL, 0, 0, '1', 0);
-- 编辑
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082703451490312', '2023082703451490310', '编辑小学美术教学器材配备标准', NULL, NULL, 0, NULL, NULL, 2, 'primaryartequipment:edu_primary_art_equipment:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-27 15:45:31', NULL, NULL, 0, 0, '1', 0);
-- 删除
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082703451490313', '2023082703451490310', '删除小学美术教学器材配备标准', NULL, NULL, 0, NULL, NULL, 2, 'primaryartequipment:edu_primary_art_equipment:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-27 15:45:31', NULL, NULL, 0, 0, '1', 0);
-- 批量删除
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082703451490314', '2023082703451490310', '批量删除小学美术教学器材配备标准', NULL, NULL, 0, NULL, NULL, 2, 'primaryartequipment:edu_primary_art_equipment:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-27 15:45:31', NULL, NULL, 0, 0, '1', 0);
-- 导出excel
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
VALUES ('2023082703451490315', '2023082703451490310', '导出excel_小学美术教学器材配备标准', NULL, NULL, 0, NULL, NULL, 2, 'primaryartequipment:edu_primary_art_equipment:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2023-08-27 15:45:31', NULL, NULL, 0, 0, '1', 0);
-- 导入excel
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
